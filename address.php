...
<html lang="en">
	<head>
		...
		<?
			...
			$folderLevel = 0;
			$folderString = '';
			$names = array('Home', 'Checkout');
			$links = array('index.php', 'address.php');
			$pageHeight = 800;
		...
		<div class="pageWrapper">
			...
			<div class="pageContent" style="height:<?echo $pageHeight;?>px;">
				...
				<div style="position:absolute;top:230px;left:50px;">
					<div style="position:absolute;left:-25px;top:-80px;" >
						...
						<form id="form_123" onsubmit="return validate_form_123(this)" action="address.php" accept-charset="UTF-8" method="post" target="_self" enctype="multipart/form-data" >
							...
							<div style="width:400px;height:40px;">
								<p class="Wp-Normal-P"><label for="edit_2"><span class="Heading-3-C">*Country:</span></label><select onChange="submit();" style="width:210px;float:right;" name="country">
					...
					<form id="form_25" autocomplete="off" name="userinfo_2" onsubmit="return validate_form_25(this)" action="paypal/class/PayWithOptions2.php" accept-charset="UTF-8" method="post" target="_self" enctype="multipart/form-data" >
						...
						<div style="width:400px;height:40px;">
						<p class="Wp-Normal-P"><span class="Heading-3-C">*</span><label for="edit_1"><span class="Heading-3-Ca">Name:</span></label><input style="float:right;width:206px;" value="<?echo $_POST['firstname'];?>" type="text" id="edit_1" name="firstname" value="" ></p>
						</div>

						<div style="width:400px;height:40px;">
						<p class="Wp-Normal-P"><span class="Heading-3-C">*</span><label for="edit_1"><span class="Heading-3-Ca">Address Line 1:</span></label><input style="float:right;width:206px;" value="<?echo $_POST['line1'];?>" type="text" id="edit_1" name="line1" value="" ></p>
						</div>



						<div style="width:400px;height:40px;">
						<p class="Wp-Normal-P"><label for="edit_2"><span class="Heading-3-Ca">&nbsp;Address Line 2:</span></label><input style="float:right;width:206px;" type="text" id="edit_2" value="<?echo $_POST['line2'];?>" name="line2" value="" ></p>
						</div>



						<div style="width:400px;height:40px;">
						<p class="Wp-Normal-P"><span class="Heading-3-C">*</span><label for="edit_2"><span class="Heading-3-Ca">Town / City:</span></label><input style="float:right;width:206px;" type="text" value="<?echo $_POST['town'];?>" id="edit_2" name="town" value="" ></p>
						</div>


						<div style="width:400px;height:40px;">
						<p class="Wp-Normal-P"><span class="Heading-3-C">*</span><label for="edit_2"><span class="Heading-3-Ca">State / County / Region:</span></label><input style="float:right;width:206px;" value="<?echo $_POST['state'];?>" type="text" id="edit_2" name="state" value="" ></p>
						</div>

						<div style="width:400px;height:40px;">
						<p class="Wp-Normal-P"><span class="Heading-3-C">*</span><label for="edit_2"><span class="Heading-3-Ca">Postcode / ZIP code:</span></label><input style="float:right;width:206px;" value="<?echo $_POST['postcode'];?>" type="text" id="edit_2" name="postcode" value="" ></p>
						</div>

						<div>
							<div style="width:400px;height:40px;float:left;">
							<p class="Wp-Normal-P"><span class="Heading-3-C">*</span><label for="edit_2"><span class="Heading-3-Ca">Contact Email:</span></label><input style="float:right;width:206px;" value="<?echo $_POST['email'];?>" type="text" id="edit_2" name="email" value="" ></p>
							</div>
				...
				<div id="txt_486" style="position:absolute;left:90px;top:750px;width:250px;height:169px;overflow:hidden; " >
					...
					<ul class="Body-P">
						...
						<li class="Body-P-P0"><span class="Body-C">Due to the nature of Zooqie selling products across many different brands, it is
							only possible to purchase items one at a time.</span></li>
					</ul>
				</div>

				<div id="txt_487" style="position:absolute;left:340px;top:750px;width:250px;height:169px;overflow:hidden; " >
					<p class="Wp-Body-P"><span class="Body-C"><br></span></p>
					<ul class="Body-P">
						<h3 class="Wp-Heading-2-P"><span class="Heading-3-C">Paypal</span></h3>
						<li class="Body-P-P0"><span class="Body-C">All Payments are made securely through PayPal.</span></li>
					</ul>
				</div>

				<div id="txt_488" style="position:absolute;left:590px;top:750px;width:250px;height:199px;overflow:hidden; " >
					...
					<ul class="Body-P">
						...
						<li class="Body-P-P0"><span class="Body-C">Many of our brands are relatively small and/or new and their delivery times may be
							slightly longer than may be expected from other websites.</span>
						</li>
					</ul>
				</div>
