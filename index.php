...
<html lang="en-gb">
    ...
    <body style="background:#ffffff url('images/backgroundpattern.png') repeat fixed top center; height:<?echo $tmpHeight;?>px;padding-top:80px;">
        <?php
            include('php/header.php');
        ?>
        <div style="background-color:#ffffff;margin-left:auto;margin-right:auto;position:relative;width:1000px;min-height:100%;">
        ...
        <div style="width: 1000px; height: 355px;">
