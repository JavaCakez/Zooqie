...
<!-- CREATE USABLE DASHBOARD AREA -->
	<div style="position:relative; top:130px; width:100%;">
        ...
        <!--Views Report-->
        <div style = "position:absolute; top: 310px; left: 60px; width:880px; height: 380px; background-color:#D1D1D1; text-align: center;">



            <div style = "position:absolute; top: 10px; width: 100%; text-align: center;">
                <span class="Heading-2-C">Unhandled transactions</span>
            </div>
			...
			<tr>
				<th>Date</th><th>Item Number</th><th>Description</th><th>Name</th><th>Address</th>
			</tr>";
                ...
                $result = mysqli_query($con,"SELECT * FROM unhandledtransactions");
                ...
                while($row = mysqli_fetch_array($result))
                {
                    ...
                    $name =  $row['Name'];
                    $address =  $row['Address1'] . ', ' . $row['Address2'] . ', ' . $row['Town'] . ', ' . $row['Region'] . ', ' . $row['Postcode'];
            ...
            <form action="force_sale.php" accept-charset="UTF-8" method="post" target="_self" enctype="application/x-www-form-urlencoded"">
                <input type="hidden" name="Date" value="' . $row['Date'] . '">
                <input type="hidden" name="Price" value="' . $row['Price'] . '">
                <input type="hidden" name="Shipping" value="' . $row['Shipping'] . '">
                <input type="hidden" name="Brand_username" value="' . $row['Brand_username'] . '">
                ...
                <input type="hidden" name="Address2" value="' . $row['Address2'] . '">
                ...
                <input type="submit" id="butn_12" value="Force sale">
            </form>
            ...
            <form action="delete_unhandled_transaction.php" accept-charset="UTF-8" method="post" target="_self" enctype="application/x-www-form-urlencoded"">
                <input type="hidden" name="Date" value="' . $row['Date'] . '">
                <input type="hidden" name="Price" value="' . $row['Price'] . '">
                <input type="hidden" name="Shipping" value="' . $row['Shipping'] . '">
                <input type="hidden" name="Brand_username" value="' . $row['Brand_username'] . '">
                ...
                <input type="hidden" name="Postcode" value="' . $row['Postcode'] . '">
                <input type="hidden" name="Contact" value="' . $row['Contact'] . '">
                <input type="submit" id="butn_12" value="Delete">
            </form>
