...
<a href="vests.php"><img src="../images/QS.png" border="0" width="406" height="298" id="qs_314" alt="" onload="OnLoadPngFix()" style="position:absolute;left:173px;top:140px;" class="fader_img"></a>
...
<a href="tees.php"><img src="../images/QS.png" border="0" width="413" height="606" id="qs_317" alt="" onload="OnLoadPngFix()" style="position:absolute;left:587px;top:140px;" class="fader_img"></a>
...
<a href="shorts.php"><img src="../images/QS.png" border="0" width="406" height="298" id="qs_434" alt="" onload="OnLoadPngFix()" style="position:absolute;left:173px;top:448px;" class="fader_img"></a>
...
a.hlink_6:link {color:#cdcfd2;}
a.hlink_6:visited {color:#cdcfd2;}
a.hlink_6:hover {color:#e52b50;}
a.hlink_6:active {color:#cdcfd2;}
.Heading-1-P
{
...
.Body-C-C0
{
    font-family:"Lato", sans-serif; color:#fafafa; font-size:14px; line-height:1.29em;
}
.Heading-1-C-C1
{
