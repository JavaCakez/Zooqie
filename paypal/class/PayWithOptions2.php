...
$totalAmount = $_POST["amount"]+$_POST["ship"];
$Receivers = array();
$Receiver = array(
	'Amount' => $totalAmount, 											// Required.  Amount to be paid to the receiver.
...
$brandAmount = $totalAmount - $zookieamt;
$Receiver = array(
	'Amount' => $brandAmount, 											// Required.  Amount to be paid to the receiver.
...
$InvoiceItem = array(
	...
	'Identifier' => $Item_number, 						// External reference to item or item ID.
