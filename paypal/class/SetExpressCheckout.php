...
$SECFields = array(
					...
					'cancelurl' => $domain . 'paymentfail.php', 							// Required.  URL to which the customer will be returned if they cancel payment on PayPal's site.
					...
					'brandname' => 'Zookie', 							// A label that overrides the business name in the PayPal account on the PayPal hosted checkout pages.  127 char max.
...
$Payments = array();
$Payment = array(
				'amt' => $brandamt+$_POST["shipping"], 	// Required.  The total cost of the transaction to the customer.  If shipping cost and tax charges are known, include them in this value.  If not, this value should be the current sub-total of the order.
				...
				'shippingamt' => $_POST["shipping"], 					// Total shipping costs for this order.  If you specify SHIPPINGAMT you mut also specify a value for ITEMAMT.
				...
				'notetext' => 'Size: '.$_POST["os0"], 						// Note to the merchant.  255 char max.  
				...
				'sellerpaypalaccountid' => $_POST["business"]			// A unique identifier for the merchant.  For parallel payments, this field is required and must contain the Payer ID or the email address of the merchant.
				);
				
$PaymentOrderItems = array();
$Item = array(
			'name' => $_POST["item_name"], 							// Item name. 127 char max.
			'desc' => '', 							// Item description. 127 char max.
			'amt' => $brandamt, 								// Cost of item.
			'number' => $_POST["item_number"], 							// Item number.  127 char max.
