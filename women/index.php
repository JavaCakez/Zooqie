...
<title>Women | Shop women&#39;s clothes, dresses, jewellery, tees &amp; more | ZOOQIE</title>
<meta name="viewport" content="width=1000">
<link rel="icon" href="../favicon.ico" type="image/x-icon">
<link rel="shortcut icon" href="../favicon.ico" type="image/x-icon">
<meta name="Description" content="Discover the latest women's clothing and accessories from independent brands across the UK with Zooqie. Shop for women's dresses, tops, jewellery and more." />
...
echoNavBar(1, array('Home', 'Women'), array('../index.php', '../women'));
?>
...
<div id="frag_58" style="position:absolute;left:20px;top:204px;width:132px;height:262px;">
    <!--Body-->
        ...
        if(file_exists("db_settings.php")) {include("db_settings.php");}
    		...
    		{
    			$result = mysqli_query($con,"SELECT * FROM products WHERE Brand IN (SELECT ID FROM brands Where Live = 1) AND (Gender = 'F' OR Gender = 'U')");
